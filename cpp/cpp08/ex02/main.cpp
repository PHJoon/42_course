...
/*   Updated: 2023/11/22 09:10:22 by hyungjpa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    MutantStack<int>::const_iterator mscIt = ms.begin();
    MutantStack<int>::const_iterator mscIte = ms.end();
    std::cout << "ms begin [ ";
    while (mscIt != mscIte)
    {
        std::cout << *mscIt;
    ...
    MutantStack<int>::const_reverse_iterator mscrIt = ms.rbegin();
    MutantStack<int>::const_reverse_iterator mscrIte = ms.rend();
    std::cout << "ms rbegin [ ";
